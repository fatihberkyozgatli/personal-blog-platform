# Pages from the Red Diary: Stage 1 — Foundation & Database
...
- `build` / `typecheck` / `lint` / `test` all green (the test suite has since grown well beyond Stage 1; run `npm test`).
